...
public class AudioRecordButton extends Button implements myRecorder.AudioStageListener {
    ...
    //核心录音类
    private myRecorder mAudioManager;
    //当前录音时长
    ...
    public AudioRecordButton(Context context, AttributeSet attrs) {
        ...
        //实例化录音核心类
        mAudioManager = myRecorder.getInstance();
...
//
                    ...
                    mAudioManager.stop();// release释放一个mediarecorder
                    doShock();
                    if (mListener != null) {// 并且callbackActivity，保存录音
                        mListener.onFinished(mTime, mAudioManager.getCurrentFilePath());
